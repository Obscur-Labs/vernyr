...
const DISMISSED = 'vernyr_install_dismissed';
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-3 flex gap-2">
            {deferred && (
              <button onClick={install} className="hig-press rounded-full bg-accent px-3.5 py-2 text-[13px] font-semibold text-white">
                Install
              </button>
            )}
            <button onClick={dismiss} className="hig-press rounded-full bg-muted px-3.5 py-2 text-[13px] font-semibold text-t2">
              Not now
            </button>
          </div>
        </div>
