...
export function DropOverlay({ show }: { show: boolean }) {
  if (!show) return null;
  return (
    <div className="pointer-events-none absolute inset-0 z-40 flex items-center justify-center p-4 animate-backdrop-in" style={{ background: 'color-mix(in srgb, var(--im-chrome) 85%, transparent)' }}>
...
export function AttachmentTray({
  ...
  return (
    <div className="flex-shrink-0 border-t im-chrome px-4 pt-3 sm:px-5 animate-overlay-in" role="region" aria-label="Attachments to send">
