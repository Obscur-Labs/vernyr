...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    href: '/members',
    label: 'Members',
    keywords: 'team staff users accounts invite seats',
    module: 'members',
...

  {
    ...
    keywords: 'student university logins portal credentials password access',
    module: 'portal_accounts',
    icon: icon(<path d="M10 2a5 5 0 00-5 5v2H4a2 2 0 00-2 2v5a2 2 0 002 2h12a2 2 0 002-2v-5a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm3 7V7a3 3 0 10-6 0v2h6z" />),
  },
  {
    href: '/roles',
    label: 'Roles & access',
    keywords: 'permissions presets modules rbac privileges security matrix',
    module: 'access',
    icon: icon(<path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />),
  },
...
/** Nav entries this caller may actually open. */
export const navFor = (permissions: PermissionMap | undefined) =>
  NAV_ITEMS.filter((i) => !i.module || allows(permissions, i.module, 'read'));

/** Sidebar entries only — `hidden` items live in the header menu. */
export const sidebarFor = (permissions: PermissionMap | undefined) =>
  navFor(permissions).filter((i) => !i.hidden);
...
/** `/students/abc123` → Students → abc123. */
